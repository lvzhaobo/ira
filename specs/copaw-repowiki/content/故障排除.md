...
- [faq.zh.md](file://website/public/docs/faq.zh.md)
- [faq.en.md](file://website/public/docs/faq.en.md)
...
participant INST as "安装脚本(install.sh/.bat)"
