...
| 文件 | 操作 | 说明 |
|------|------|------|
| `specs/workshop/module-03-knowledge-copaw/openapi/kb-qa-contract.yaml` | 维护 | OpenAPI 3.0 契约（**规格真源**，相对仓库根） |
| `specs/workshop/module-03-knowledge-copaw/docs/01-Spec-知识库与问答-CoPaw底座-v0.1.md` | 已存在 | 参考 API 行为定义 |
