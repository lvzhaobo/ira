...
| 资源 | 路径 | 用途 |
|------|------|------|
| **M2 骨架代码** | [`m2-glue-reference/`](../../../modules-practice/module-02/m2-glue-reference/) | Provider 接口 + Mock 实现 + Job FSM + pytest |
| **M2 参考前端** | [`m2-glue-reference/frontend/`](../../../modules-practice/module-02/m2-glue-reference/frontend/) | React 运维台 SPA（`npm run dev` → `http://127.0.0.1:5180`） |
| **Mock 数据源** | [`ira-vin-mocks/`](../../../modules-practice/module-02/ira-vin-mocks/) | 新浪/东财/Wind 模拟 API + 仿门户页面 |
| **UI 主视觉** | [`ui-master-demo/index.html`](../../../modules-practice/module-02/ui-master-demo/index.html) | 深蓝主色 + 红色强调的 UI 风格参考 |

### 2️⃣ 规格文档（契约真源）

| 优先级 | 文档 | 路径 |
|--------|------|------|
| **P0** | API 接口规格 | [`02-模块-GlueCoding-多源数据/09-API接口规格.md`](./docs/02-模块-GlueCoding-多源数据/09-API接口规格.md) |
| **P0** | 数据模型与存储 | [`02-模块-GlueCoding-多源数据/10-数据模型与存储规格.md`](./docs/02-模块-GlueCoding-多源数据/10-数据模型与存储规格.md) |
| **P0** | 功能规格说明 | [`02-模块-GlueCoding-多源数据/06-功能规格说明.md`](./docs/02-模块-GlueCoding-多源数据/06-功能规格说明.md) |
| P1 | 用户故事与验收 | [`02-模块-GlueCoding-多源数据/05-用户故事与验收标准.md`](./docs/02-模块-GlueCoding-多源数据/05-用户故事与验收标准.md) |
| P1 | 测试策略 | [`02-模块-GlueCoding-多源数据/13-测试策略与质量门禁.md`](./docs/02-模块-GlueCoding-多源数据/13-测试策略与质量门禁.md) |
| P1 | 实施里程碑 | [`02-模块-GlueCoding-多源数据/12-实施计划与里程碑.md`](./docs/02-模块-GlueCoding-多源数据/12-实施计划与里程碑.md) |

### 3️⃣ 快速启动命令

```bash
# 在仓库根执行；练习代码位于 modules-practice/module-02/

# ① Mock 数据源（ira.vin 模拟）
cd modules-practice/module-02/ira-vin-mocks
...
> 详见 [`12-实施计划与里程碑.md`](./docs/02-模块-GlueCoding-多源数据/12-实施计划与里程碑.md) 和 [`13-测试策略与质量门禁.md`](./docs/02-模块-GlueCoding-多源数据/13-测试策略与质量门禁.md)
...
| 文档 | 路径 |
|------|------|
| 系统架构与技术选型 | [`02-模块-GlueCoding-多源数据/08-系统架构与技术选型.md`](./docs/02-模块-GlueCoding-多源数据/08-系统架构与技术选型.md) |
| 非功能需求与约束 | [`02-模块-GlueCoding-多源数据/07-非功能需求与约束.md`](./docs/02-模块-GlueCoding-多源数据/07-非功能需求与约束.md) |
| Agent 编排与安全 | [`02-模块-GlueCoding-多源数据/11-Agent编排与安全规格.md`](./docs/02-模块-GlueCoding-多源数据/11-Agent编排与安全规格.md) |
| 需求追踪矩阵 | [`02-模块-GlueCoding-多源数据/14-需求追踪矩阵.md`](./docs/02-模块-GlueCoding-多源数据/14-需求追踪矩阵.md) |
| 企业研发规范 | [`00-全项目-企业研发规范-Mock.md`](../00-全项目-企业研发规范-Mock.md) |
| 阿里云资源清单 | [`00-阿里云资源与CoPaw清单.md`](../00-阿里云资源与CoPaw清单.md) |
