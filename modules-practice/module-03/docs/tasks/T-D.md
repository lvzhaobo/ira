...
| `openapi/kb-qa-contract.yaml` | 只读 | 参考 API Schema 和示例 |
...
【必须遵守】《03-任务地图与Qoder-Quest执行指南》§3;《01-Spec》§3.4、§7;`openapi/kb-qa-contract.yaml`。

【契约参考】
- 行为契约:`01-Spec` §3.4 - 定义接口语义和业务规则
- 技术契约:`openapi/kb-qa-contract.yaml` - 完整 OpenAPI Schema,含示例
